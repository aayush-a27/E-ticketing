...
const CheckOut = () => {
  ...
  const { seatSelected, selectedTime, title } = location.state;

  return (
    <div className="box hover:shadow-xl hover:shadow-green-500/50  border-2 border-black rounded-2xl mt-10 ml-32 mr-32 pt-10 pl-32 gap-10 flex flex-col items-start justify-center relative">
      {/* Bouncing ball */}
      ...
      <div className=" flex items-center justify-center gap-20">
        ...
        <div className="text text-4xl font-bold flex items-center justify-center py-2">Selected Show</div>
        <div className="text-2xl font-medium py-2 items-center justify-center flex">{title}</div>
      </div>
